...
class TestDatabase:
    ...
    def test_save_and_get_assignments(self, temp_db):
        ...
        assignments = [{"id": 1, "title": "Major Order 1"}, {"id": 2, "title": "Major Order 2"}]
    ...
    def test_save_and_get_dispatches(self, temp_db):
        ...
        dispatches = [{"id": 1, "message": "News 1"}, {"id": 2, "message": "News 2"}]
    ...
    def test_save_and_get_planet_events(self, temp_db):
        ...
        events = [{"id": 1, "event": "Attack"}, {"id": 2, "event": "Defense"}]
